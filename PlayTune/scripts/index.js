...
//   );
  ...
  let w = (c.width = window.innerWidth),
    ...
    opts = {
      ...
      strings_1: [["  Happy birthday!", "  Ritu  "], ["   May all happiness,"], ["all luck"], [" always surround", "you  "], ["  Now welcome the", "    Minions to celebrate", "   your birthday haha~"]],
...
function message(){
  window.alert("i knew you would like it. :p")
  document
}
